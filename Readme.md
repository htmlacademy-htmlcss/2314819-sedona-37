...
* Студент: [Данил Гурин](https://up.htmlacademy.ru/htmlcss/37/user/2314819).
* Наставник: `Михаил Шишов`
* Ссылка на профиль наставника: (https://htmlacademy.ru/profile/id2351985);
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/2314819-sedona-37) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
